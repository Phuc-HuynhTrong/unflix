        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text('Hello, Long time no see!', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white),),
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child:  Text('Đăng nhập', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black),),
              ),
            ),
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>FogotPasswordScreen()));
              },
              child: Container(
                alignment: Alignment.centerRight,
                child: Text('Quên mật khẩu?', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white),),),
            ),
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      ...
                      child: Text('Đăng ký', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xffF6C700)),)),
